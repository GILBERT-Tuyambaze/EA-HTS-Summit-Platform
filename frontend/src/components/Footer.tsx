      ...
      <div className="footer-grid">
        <div className="footer-col footer-col-brand">
          ...
          <div className="footer-social-row">
            <a href="#" aria-label="LinkedIn" className="footer-social-button">
            ...
            <a href="https://x.com/EAHTS2027" aria-label="X (Twitter)" className="footer-social-button">
              <svg viewBox="0 0 24 24" fill="currentColor" className="footer-social-svg">
            ...
            <a href="https://www.facebook.com/profile.php?id=61592386870922" aria-label="Facebook" className="footer-social-button">
              <svg viewBox="0 0 24 24" fill="currentColor" className="footer-social-svg">
      ...
      <div className="footer-bottom-bar">
        ...
        <div className="footer-bottom-right">
          <span className="footer-micro-links">
            ...
            <a href="mailto:ieeeahts27@gmail.com?subject=General%20Inquiry">Contact</a>
          </span>
        </div>
      </div>
    </div>
